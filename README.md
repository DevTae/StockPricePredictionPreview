...
- 성능 평가
  - 해당 [링크](https://www.aitimes.com/news/articleView.html?idxno=139470) 내용을 벤치마킹하여 `52.5%` 를 목표로 설정 (24.1.24)
  - 성능 검증 결과 ____ % 와 같았음. (학습 중)
...
#### 현재 진행 상황
  - 정확도 목표 재설정 진행
    ...
    - 해당 [링크](https://www.aitimes.com/news/articleView.html?idxno=139470) 내용(21년 기준 정확도 57.4% 가 신기록 달성)을 벤치마킹 삼아 Validation Dataset 에 대하여 `52.5%` 를 달성할 수 있도록 한다.
